...
local yy = 580; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
local xx2 = 950; -- Same code as above, but for boyfriend left, right
local yy2 = 580; -- Same code as above, but for boyfriend up, down
